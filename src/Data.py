...
class MedicalData:
    class QuestionPair:
        ...
        def put_context(self, answer_start, context, is_impossible):
            ...
            Args:
                ...
                context: paragraph comprised with text  
                is_impossible: answerability is present or not 
        ...
        def update_question(self, length, num_token):
            """ 
            Update some properties of the class 
    ...
    def extract_put_qas(self, qas):
        ...
        # Multiple questions are generated from same passage.
        # Answer has two keys - text and answer_start in the context
    ...
    def get_answer(self, qa_pair):
        ...
        # answer
        answers = []
        d_answer = {"text": qa_pair._answer, "answer_start": qa_pair._answer_start}
    ...
    def write_json_file(self, path_to_file, file_name="train.json", is_debug=False):
        ...
        for qa_pair in self._qa_pair:
            # qas
            d_data = {"context": qa_pair._context, "qas": self.get_question(qa_pair)}
