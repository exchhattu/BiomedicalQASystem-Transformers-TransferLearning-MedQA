...
class SquadExampleExtended(object):
    """
    A single training/test example for the Squad dataset.
    For examples without an answer, the start and end position are -1.
    """
    ...
    def __init__(self,
        ...
        self.orig_start_position = orig_start_position
        self.is_impossible = is_impossible
...
def read_squad_examples_extended(input_file, is_training, version_2_with_negative):
    ...
    for entry in input_data:
        for paragraph in entry["paragraphs"]:
            ...
            for qa in paragraph["qas"]:
                    ...
                    if not is_impossible:
                        ...
                        if actual_text.find(cleaned_answer_text) == -1:
                            ...
                            if s_idx == -1 and e_idx == -1: 
                                invalid_count += 1
                                print("WARN: still invalid ", qas_id) 
                                continue
                            print("WARN: reovered ", qas_id) 
                ...
                print("INFO: example work ", qas_id) 
                example = SquadExampleExtended(
                    qas_id=qas_id,
                    ...
                    orig_start_position = answer_offset,
                    is_impossible=is_impossible)
                examples.append(example)
    print("INFO: invalid count ", invalid_count)
    print("INFO: recovered count", recover_count) 
    print("INFO: totalcount ", total_count)
    return examples
